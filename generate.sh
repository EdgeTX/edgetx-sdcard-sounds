...
./voice-gen.py voices/ja-JP.csv ja-JP-NanamiNeural ja || exit 1
...
./voice-gen.py voices/sv-SE.csv sv-SE-SofieNeural sv || exit 1
./voice-gen.py voices/sv-SE_scripts.csv sv-SE-SofieNeural sv/SCRIPTS || exit 1
./voice-gen.py voices/zh-CN.csv zh-CN cn || exit 1
